...
$contact_form_global = false;
$location = array();

if( class_exists('acf') ):

	$contact_form_global = get_field('contact_form_availability', 'option');

	if ($contact_form_global !== 'global'):
		...
		$location[] = form_builder_location_array( 'form-builder-contact-form-settings', 'options_page' );
		// echo "<pre>"; var_dump($location); echo "</pre>";
	endif;	

endif;

if( ($contact_form_page || $contact_form_global) && function_exists('acf_add_local_field_group') ):
...
// acf_add_local_field_group(array (
// 	'key' => 'group_59ce465a6542f',
// 	'title' => 'Contact Form Test Inputs',
// 	'fields' => array (
// 		array (
// 			'key' => 'field_59ce466dbb42b',
// 			'label' => 'Test Input',
// 			'name' => 'test_input',
// 			'type' => 'text',
// 			'instructions' => '',
...
// 				'param' => 'options_page',
// 				'operator' => '==',
// 				'value' => 'form-builder-contact-form-settings',
// 			),
// 		),
// 	),
// 	'menu_order' => 0,
