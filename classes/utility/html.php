...
class WP_Swift_Form_Builder_Html {
    ...
    public function front_end_form($helper, $response = null, $msg = null ) {
        ...
        <div<?php $helper->get_form_wrapper_css_id() ?> class="<?php echo $helper->get_form_class(); ?>"><!-- @start form-wrapper -->
            ...
            <!-- @start form -->
            <form method="post"<?php echo $helper->get_action(); ?> name="<?php echo $helper->get_form_name(); ?>" id="<?php echo $helper->get_form_css_id(); ?>" data-id="<?php echo $helper->get_form_post_id(); ?>" data-post-id="<?php echo $helper->get_post_id(); ?>" data-type="<?php echo $helper->get_form_type() ?>" data-ajax="<?php echo $helper->get_ajax() ?>" <?php $helper->get_form_data_types() ?> class="<?php echo $helper->get_form_class() . ' ' . $helper->get_form_name(); ?>" novalidate<?php echo $helper->get_enctype(); echo $helper->get_modal(); ?>>
    ...
    public function gdpr_html_standard($helper) {
        ...
        if ( $opt_ins ): ?>
            ...
            <div class="form-group sign-up" id="marketing-sign-up-group">
                ...
                <div class="form-input">
                    <div class="checkbox">
                        <div id="sign-up-details" class="sign-up-msg extra-msg"><?php echo $gdpr_settings["main_message"] ?></div>
                        ...
                        <?php foreach ($opt_ins as $key => $opt_in): ?>
                            ...
                            <?php if ( is_array($opt_in["options"]) && ( in_array("email", $opt_in["options"]) || in_array("sms", $opt_in["options"]) ) ): ?>
                                ...
                                <div class="sign-up-msg extra-msg"><?php echo $opt_in["message"] ?></div>
