...
function form_shortcode_html( $post) {
    ...
    <p>
        ...
        <input type="text" name="form_shortcode_test" id="form_shortcode_test" value="<?php echo form_shortcode_get_meta( 'form_shortcode_test' ); ?>">
        <textarea name="" id="" cols="30" rows="1" class="copy-to-clip">[form id="4"]</textarea>
        <a class="copy-shortcode" data-shortcode="[form]">Copy Shortcode</a>
    </p><?php
